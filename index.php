...
if ((isset($_SESSION['UserId']) && $_SESSION['UserId'] <= 0)  && ((isset($_GET['page']) && $_GET['page'] == 'login') || !isset($_GET) ) &&  isset($_COOKIE[$config['cookie_prefix'].'osdate_info']) ) {
	...
	list($_SESSION['lookagestart'], $_SESSION['lookageend'])= explode(':',$cookie['search_ages']);
