...
$videos = $osDB->getAll('select userid, count(*) as cnt from ! group by userid', array(USER_VIDEOS_TABLE));

foreach ($videos as $video) {
	$osDB->query('update ! set videos_cnt=? where id=?', array(USER_TABLE, $video['cnt'], $video['userid']));
