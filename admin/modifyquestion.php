...
$osDB->query( "UPDATE ! SET question=?, description	=?, guideline=?,control_type=?, maxlength=?, mandatory=?, section=?, extsearchable=?, extsearchhead	=?,enabled=?, gender =? WHERE id = ?", array( QUESTIONS_TABLE, $question, $description, $guideline, $controltype, $maxlength, $mandatory, $section, $extsearchable, $extsearchhead, $enabled, $gender, $_POST['txtid'] ) );
