<!-- dropdown panel menu -->
<div class="dropdowncontainer" style="padding-left:4px;" >
...
<div class="dropdownsection"><a href="#" onclick="return clickreturnvalue()" onmouseover="dropdownmenu(this, event, 'mylists')" class="dropmenulink">My Lists</a>
...
<div class="dropdownsection"><a href="#" onclick="return clickreturnvalue()" onmouseover="dropdownmenu(this, event, 'tools')" class="dropmenulink">Tools</a>
...
<div class="dropdownsection" style="width: 130px; display: inline; float: left;"><a href="#" onclick="return clickreturnvalue()" onmouseover="dropdownmenu(this, event, 'mymembership')" class="dropmenulink">My Membership</a>
...
{* Plugins *}
<div class="dropdownsection" style="width: 130px; display: inline; float: left;"><a href="#" onclick="return clickreturnvalue()" onmouseover="dropdownmenu(this, event, 'plugins')" class="dropmenulink">	{lang mkey='plugin'}</a>
