...
<div class="module_detail_inside" >
	...
	<table width="100%" border="0" cellpadding="{$config.cellpadding}" cellspacing="{$config.cellspacing}">
		<tr>
			...
			<td width="65%">
				<input type="text" class="textinput" name="cc_owner" />
			</td>
		</tr>
		<tr>
			<td>{lang mkey='cc_number'}</td>
			<td><input type="text" class="textinput"  name="cc_number" /></td>
		</tr>
		<tr>
			<td>{lang mkey='cc_exp_date'}</td>
			<td>
				{html_select_date_translated display_days=false end_year=+10 prefix="cc_expires_"}
			</td>
		</tr>
	</table>
</div>
