...
<div class="top_margin_6px">
	{assign var="page_hdr02_text" value="{lang mkey='insert_article'}"}
		...
		<div class="line_outer">
			<form method="post" name="frmArticle" action="savearticle.php">
				<table border="0" cellpadding="1" cellspacing="2" >
					<tr><td>{lang mkey='article_title'}:<font class="required_info">{$smarty.const.REQUIRED_INFO}</font></td>
					<td><input type="text" class="textinput"  name="txttitle" id="txttitle" size="50" value="{$smarty.session.txttitle}" /></td></tr>
					...
					<tr><td colspan="2"><textarea name="txttext" id="txttext" style="width:550px;height:300px;">{$smarty.session.txttext }</textarea></td>
					</tr>
					<tr><td colspan="2" align="center"><input type="submit" class="formbutton" value="{lang mkey='submit'}" onclick="return checkMe();" /></td>
					</tr>
				</table>
			</form>
		</div>
