	...
	<form action="{$smarty.section.PHP_SELF}" method="post">
        <input type="hidden" name="db_config" value="true" />
			<table   cellspacing="{$config.cellspacing}" cellpadding="0" width="550" border="0">
	  		<tbody>
	 			<tr>
	  				<td width="25%">{lang mkey='db_name'}</td>
	  				<td width="75%"><input type="text" class="textinput"  name="db_name" value="{$db.db_name}" /></td>
	 			</tr>
	 			<tr>
	 			...
	 			<tr>
	  				...
	  				<td><input type="text" class="textinput"  name="photos_url" value="{$db.photos_url}" /></td>
	 			</tr>
				<tr>
					<td>&nbsp;</td>
					<td>
