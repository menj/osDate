...
function checkme()
{ldelim}
	return confirm("{lang mkey='delstates_msg'}");
{rdelim}
</script>
{strip}
{assign var="page_hdr01_text" value="{lang mkey='load_states'}"}
{assign var="page_title" value="{lang mkey='load_states'}"}
	...
	<div class="line_outer">
		...
		<div class="line_top_bottom_pad">
			...
			<table border="0">
				...
				<tr><td width="30%">{lang mkey='statefile'}:</td>
					<td width="70%">
				...
				<tr>
					<td colspan="2">
						<input type=submit  class="formbutton" name="loadstates" value="{lang mkey='load_states_button'}" />&nbsp;&nbsp;
						<input type=submit  class="formbutton" name="delstates" value="{lang mkey='delete_states'}" onclick="javascript: return checkme();" />&nbsp;&nbsp;
					</td>
				</tr>
			</table>
			</form>
