...
<div class="top_margin_6px" style="text-align:left;">
	{assign var="page_hdr02_text" value="{lang mkey='modify_story'}"}
		...
		{/if}
			...
			<input type="hidden" name="id" value="{$story.storyid}" />
				<table width="100%" border="0" align="center" cellpadding="1" cellspacing="2">
					<tr><td>{lang mkey='news_header'}:<font class="required_info">{$smarty.const.REQUIRED_INFO}</font></td><td><input type="text" class="textinput"  name="txttitle" size="50" value="{$story.header|stripslashes}" /></td></tr>
					...
					<tr><td colspan="2">
						<textarea name="txttext" id="txttext" style="width:550px;height:300px;">{$story.text|stripslashes }</textarea></td>
					</tr>
					<tr><td colspan="2" align="center">
						<input type="submit" class="formbutton" value="{lang mkey='modify'}" />&nbsp;
						<input type="reset" class="formbutton" value="{lang mkey='reset'}" /></td>
					</tr>
				</table>
			</form>
		</div>
