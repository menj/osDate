...
<div class="module_detail_inside" >
	...
	<table width="100%" border="0" cellpadding="{$config.cellpadding}" cellspacing="{$config.cellspacing}">
		<tr>
			...
			<td width="65%">
				<input type="text" class="textinput"  name="ipayment_cc_owner" />
			</td>
		</tr>
		<tr>
			<td>{lang mkey='cc_number'}</td>
			<td><input type="text" class="textinput"  name="ipayment_cc_number" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td>{lang mkey='cc_cvv_number'}</td><td><input type="text" class="textinput"  name="ipayment_cc_checkcode" size="4" maxlength="3" />{lang mkey='cvv_help'}</td>
		</tr>
	</table>
</div>
{/strip}
