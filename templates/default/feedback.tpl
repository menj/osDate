...
<div  style="vertical-align:top;" >
	{assign var="page_hdr01_text" value="{lang mkey='feedback'}"}
	{assign var="page_title" value="{lang mkey='feedback'}"}
	{include file="page_hdr01.tpl"}
	<div class="module_detail_inside">
	{if $success}
		{assign var="error_message" value="{lang mkey='feedback_thanks'}" }
	...
	{else}
		...
		<table border="0" cellpadding="{$config.cellpadding}" cellspacing="{$config.cellspacing}">
			<tr>
				<td width="91">{lang mkey='subject_colon'}</td>
			...
			<tr>
				<td valign="top">{lang mkey='comments_colon'}
				<font class="required_info">{$smarty.const.REQUIRED_INFO}</font>
				</td>
