...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr>
		<td class="module_detail_inside"  width="100%" >
			...
			<div style="text-align:left; vertical-align:top; display:inline; float:left; height:177px;  margin-top:10px; width:412px;" >
				...
				<div style="height:33px; text-align:center;" class="module_head">
