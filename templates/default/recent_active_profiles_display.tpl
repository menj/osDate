{strip}
<div>
	{assign var="page_hdr01_text" value="{lang mkey='recent_active_users'}"|cat:$aphdr02}
	{include file="page_hdr01.tpl"}
	<div class="module_detail_inside">
{if $activeusers|@count > 0}
		{assign var="ccount" value="0"}
	{if $config.recentactiveprofiles_display=='tiny'}
		{foreach item="item" key=key from=$activeusers}
		{if $ccount==0}
			<div>
		{/if}
