...
$zipsDisp =	'<table border=0 cellspacing="'.$config['cellspacing'].'" cellpadding="'.$config['cellpadding'].'" width="100%"><tr >'.
	...
	'<input name="srchradius" value="'.$_SESSION['srchradius'].'" type="text" class="textinput" size="5" maxlength="10" /></td>'.
...
function stateOptions($countrycode) { 
	...
	if ( ($config['accept_country'] == '1' || $config['accept_country'] == 'Y' )  && $countrycode == 'AA' )  {
		return '<input name="srchlookstate_province" type="text" class="textinput" size="30" maxlength="100" />';
	}
	$ret = '';
...
function countyOptions($countrycode, $statecode) {
	...
	if (  ( ($config['accept_country'] == '1' || $config['accept_country'] == 'Y' ) && $countrycode == 'AA' ) || ( ($config['accept_state'] == '1' || $config['accept_state'] == 'Y' )  && $statecode == 'AA') ) {
		return '<input name="srchlookcounty" type="text" class="textinput" size="30" maxlength="100" />';
	}
	$ret='';
...
function cityOptions($countrycode, $statecode, $countycode) {
	...
	if (( ($config['accept_county'] == '1' || $config['accept_county'] == 'Y' ) && $countycode == 'AA') ||  ( ($config['accept_country'] == '1' || $config['accept_country'] == 'Y' ) && $countrycode == 'AA' ) || ( ($config['accept_state'] == '1' || $config['accept_state'] == 'Y' )  && $statecode == 'AA') ) {
		return '<input name="srchlookcity" type="text" class="textinput" size="30" maxlength="100" />';
	}
...
function zipOptions($countrycode, $statecode, $countycode, $citycode) {
	...
	if (( ($config['accept_county'] == '1' || $config['accept_county'] == 'Y' ) && $countycode == 'AA') ||  ( ($config['accept_country'] == '1' || $config['accept_country'] == 'Y' ) && $countrycode == 'AA' ) || ( ($config['accept_state'] == '1' || $config['accept_state'] == 'Y' ) && $statecode == 'AA') || ( ($config['accept_city'] == '1' || $config['accept_city'] == 'Y' ) && $citycode == 'AA')) {	
		return '<input name="srchlookzip" type="text" class="textinput" size="30" maxlength="100" />';
	}
	$ret='';
