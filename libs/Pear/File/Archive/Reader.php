 ...
 * @version    CVS: $Id: Reader.php,v 1.1 2006/07/15 21:31:20 cvs Exp $
...
class File_Archive_Reader
{
    ...
    function getMime()
    {
        require_once PEAR_DIR."File/Archive/Reader/MimeList.php";
    ...
    {
        require_once PEAR_DIR."File/Archive/Predicate/Current.php";
