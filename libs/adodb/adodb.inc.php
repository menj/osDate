...
*/
	...
	var $hasLimit = true;			/// support pgsql/mysql SELECT * FROM TABLE LIMIT 10
	...
	var $_isPersistentConnection = true;	/// A boolean variable to state whether its a persistent connection or normal connection.	*/
